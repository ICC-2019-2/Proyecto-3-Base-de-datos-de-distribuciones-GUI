...
import mx.unam.ciencias.icc.red.ServidorBaseDeDatosDistribucion;
...
public class ServidorProyecto3 {
    ...
    public static void main(String[] args) {
        ...
        try {
            ServidorBaseDeDatosDistribucion servidor;
            servidor = new ServidorBaseDeDatosDistribucion(puerto, archivo);
